...
/**
 * 多选图片适配器
 * 用于在GridView中显示图片，支持多选功能，显示选中状态
 */
public class MultiSelectImageAdapter extends ArrayAdapter<String> {
    ...
    public MultiSelectImageAdapter(@NonNull Context context, List<String> imagePaths) {
